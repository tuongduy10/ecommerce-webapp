  ...
  return (
    <div className="product__detail-card">
      <div className="about">
        ...
        <div className="product__detail-name">Máy xay ăn dặm</div>
        ...
        <div className="product__detail-desciption">
          <div className="bullets">
            ...
            <div className="flex items-center mb-2">
              ...
              <span className="bullet-text">Insurance</span>
            </div>
            ...
            <div className="flex items-center mb-2">
              ...
              <span className="bullet-text">Repay</span>
            </div>
            ...
            <div className="flex items-center mb-2">
              ...
              <span className="bullet-text">Delivery</span>
            </div>
          </div>
        </div>
        <hr />
        <div className="product__detail-bottom mt-4">
          ...
          <div className="product__detail-options">
            <div className="option-quality flex mb-2 items-center">
              ...
              <input
                className="text-center mr-2 pro-qty"
                type="number"
                value={quanity}
                min="1"
                max="999"
          ...
          <div className="product__detail-price">
...

            {
              <div className="mt-2">
                ...
                <div
                  className={`product__sale-bottom ${
                    isShowCodeDis ? "" : "hidden"
                  }`}
                >
